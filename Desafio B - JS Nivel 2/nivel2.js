...
let comidasFavoritas = ['milanesa', 'lasagna', 'arroz']
...
// const animales = ['perro', 'gato', 'llama']
...
// const multiplosTres = [3, 9, 12, 15, 18, 21]

// for (let i = 0; i < multiplosTres.length; i++) {
//     const element = multiplosTres[i];
//     console.log(element);
// }
...
//     console.log('Me gustan la ' + comidasFavoritas[i]);
